...
- RootZoneDatabase.csv   ← 根域数据库分类，基于[IANA官方](https://www.iana.org/domains/root/db),并结合[tld wiki](https://en.wikipedia.org/wiki/List_of_Internet_top-level_domains)修改
